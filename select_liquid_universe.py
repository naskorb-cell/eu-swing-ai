...
Върни РЕЗУЛТАТА само като чист списък, едно име на компания на ред,
без номерация, без обяснения, без markdown форматиране - само имена
(напр. "ASML Holding", "Siemens Energy", "LVMH"). До 150 имена."""
